<div>
       <button aria-label="Alarm clock timer"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 128 128">
                        ...
                        <path fill="none" stroke="#563428" stroke-linecap="round" stroke-miterlimit="10"
                            stroke-width="5" d="M47.49 63.49L63.7 72.7" />
                        <path fill="none" stroke="#563428" stroke-linecap="round" stroke-miterlimit="10"
                            stroke-width="3.5" d="M86.87 59.41L64.44 72.7" />
                        ...
                        <path fill="none" stroke="#82aec0" stroke-miterlimit="10" stroke-width="3.706"
                            d="M63.7 23.22V9.5" />
                        <path fill="#82aec0"
                    ...
                    <span wire:poll.1s>
                        {{ \Carbon\Carbon::parse(date('l, H:i:s'))->translatedFormat('H:i:s') }}
                    </span>
